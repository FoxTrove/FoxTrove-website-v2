        ...
        <div className="max-w-5xl mx-auto">
            ...
            {/* THE GUARANTEE BOX & PRICE */}
             <div id="guarantee" className="bg-gradient-to-br from-[#1E293B] to-[#0F172A] border-2 border-blue-500 rounded-2xl p-12 text-center relative max-w-4xl mx-auto shadow-[0_0_60px_-15px_rgba(59,130,246,0.5)] overflow-visible scroll-mt-32">
                 ...
                 <Button onClick={() => window.location.href = 'https://buy.stripe.com/test_9B6cN7gj96y413Af5D0Ba00'} size="lg" className="w-full md:w-auto bg-blue-600 hover:bg-blue-500 text-white font-bold text-xl px-16 py-8 h-auto uppercase shadow-xl hover:shadow-blue-500/20 hover:-translate-y-1 transition-all rounded-xl relative overflow-hidden group">
